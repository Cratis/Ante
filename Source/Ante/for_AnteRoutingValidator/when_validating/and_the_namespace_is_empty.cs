...
public class and_the_namespace_is_empty : Specification
{
    AnteOptions _options = null!;
    Exception _result = null!;

    void Establish() => _options = new() { Namespace = string.Empty };

    void Because() => _result = Cratis.Specifications.Catch.Exception(() => AnteRoutingValidator.Validate(_options));

    [Fact] void should_fail_loudly() => Assert.IsType<AnteNamespaceNotConfigured>(_result);
}
#endif
