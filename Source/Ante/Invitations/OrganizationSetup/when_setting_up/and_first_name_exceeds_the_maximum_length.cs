...
public class and_first_name_exceeds_the_maximum_length : Specification
{
    static readonly string _tooLongFirstName = new('A', PersonalNameValidation.MaximumLength + 1);
