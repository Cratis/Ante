...
public class and_setup_was_never_recorded : Specification
{
    ...
    void Because() => _result = ((BehaviorSubject<OrganizationSetupAcceptanceStatusView>)_subscriptions.GetStatus(_invitationId)).Value;

    [Fact] void should_be_pending() => Assert.Equal(OrganizationSetupAcceptanceStatus.Pending, _result.Status);
}
#endif
