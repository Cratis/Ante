...
/// </summary>
public class and_setup_is_fully_published : Specification
{
    ...
    void Because() => _result = ((BehaviorSubject<OrganizationSetupAcceptanceStatusView>)_subscriptions.GetStatus(_invitationId, "Acme", isRecorded: true, isFullyPublished: true)).Value;

    [Fact] void should_be_accepted() => Assert.Equal(OrganizationSetupAcceptanceStatus.Accepted, _result.Status);
