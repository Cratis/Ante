...
public class and_unsolicited_acceptance_is_claimed : Specification
{
    ...
    [Fact]
    void should_report_the_acceptance_field() =>
        Assert.Contains(_result.Errors, e => e.PropertyName == nameof(TestCommand.AcceptedLegalTerms));
}
#endif
